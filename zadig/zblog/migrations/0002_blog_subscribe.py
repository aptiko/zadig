...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('zblog_blogemailsubscriber', (
            ...
            ('confirmation_key', self.gf('django.db.models.fields.CharField')(max_length=40, blank=True)),
    ...
    models = {
        ...
        'zblog.blogemailsubscriber': {
            ...
            'confirmation_key': ('django.db.models.fields.CharField', [], {'max_length': '40', 'blank': 'True'}),
        ...
        'zblog.blogentry': {
            'Meta': {'ordering': "('container__id', 'seq')", 'object_name': 'BlogEntry', '_ormbases': ['core.Entry']},
        ...
        'zblog.vblog': {
            'Meta': {'ordering': "('entry', 'version_number')", 'object_name': 'VBlog', '_ormbases': ['core.VObject']},
