...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PageComment.comment_source'
        db.add_column('zpagecomments_pagecomment', 'comment_source', self.gf('django.db.models.fields.TextField')(default=''), keep_default=False)

        # Adding field 'PageComment.comment_html'
        db.add_column('zpagecomments_pagecomment', 'comment_html', self.gf('django.db.models.fields.TextField')(default=''), keep_default=False)
        for pc in orm.PageComment.objects.all():
            pc.comment_html = pc.comment
            pc.save()


    def backwards(self, orm):
        
        # Deleting field 'PageComment.comment_source'
        db.delete_column('zpagecomments_pagecomment', 'comment_source')

        # Deleting field 'PageComment.comment_html'
        db.delete_column('zpagecomments_pagecomment', 'comment_html')
    ...
    models = {
        ...
        'zpagecomments.pagecomment': {
            ...
            'comment_html': ('django.db.models.fields.TextField', [], {'default': "''"}),
            'comment_source': ('django.db.models.fields.TextField', [], {'default': "''"}),
