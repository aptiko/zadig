...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'PageComment.comment'
        db.delete_column('zpagecomments_pagecomment', 'comment')


    def backwards(self, orm):
        
        # Adding field 'PageComment.comment'
        db.add_column('zpagecomments_pagecomment', 'comment', self.gf('django.db.models.fields.TextField')(default=''), keep_default=False)
        for pc in orm.PageComment.objects.all():
            pc.comment = pc.comment_html
            pc.save()
    ...
    models = {
        ...
        'zpagecomments.pagecomment': {
            ...
            'comment_html': ('django.db.models.fields.TextField', [], {}),
            'comment_source': ('django.db.models.fields.TextField', [], {}),
