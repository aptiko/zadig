...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Entry.vobject'
        db.add_column('zadig_entry', 'vobject', self.gf('django.db.models.fields.related.OneToOneField')(related_name='irrelevant', unique=True, null=True, to=orm['core.VObject']), keep_default=False)
        # The data are migrated in zstandard/migrations/0005*. See that file.
    

    def backwards(self, orm):
        
        # Deleting field 'Entry.vobject'
        db.delete_column('zadig_entry', 'vobject_id')
