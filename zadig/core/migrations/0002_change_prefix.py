...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        for x in ('contentformat', 'vpage', 'pageentry', 'vfile', 'fileentry',
                  'vimage', 'imageentry', 'vlink', 'linkentry',
                  'vinternalredirection', 'internalredirectionentry'):
            db.rename_table('zadig_'+x, 'zstandard_'+x)
    ...
    def backwards(self, orm):
        for x in ('contentformat', 'vpage', 'pageentry', 'vfile', 'fileentry',
                  'vimage', 'imageentry', 'vlink', 'linkentry',
                  'vinternalredirection', 'internalredirectionentry'):
            db.rename_table('zstandard_'+x, 'zadig_'+x)
    ...
    models = {
        ...
        'core.contentformat': {
            'Meta': {'object_name': 'ContentFormat', 'db_table': "'zstandard_contentformat'"},
        ...
        'core.fileentry': {
            'Meta': {'ordering': "('container__id', 'seq')", 'object_name': 'FileEntry', 'db_table': "'zstandard_fileentry'", '_ormbases': ['core.Entry']},
            'entry_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['core.Entry']", 'unique': 'True', 'primary_key': 'True'})
        },
        'core.imageentry': {
            'Meta': {'ordering': "('container__id', 'seq')", 'object_name': 'ImageEntry', 'db_table': "'zstandard_imageentry'", '_ormbases': ['core.Entry']},
            'entry_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['core.Entry']", 'unique': 'True', 'primary_key': 'True'})
        },
        'core.internalredirectionentry': {
            'Meta': {'ordering': "('container__id', 'seq')", 'object_name': 'InternalRedirectionEntry', 'db_table': "'zstandard_internalredirectionentry'", '_ormbases': ['core.Entry']},
            'entry_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['core.Entry']", 'unique': 'True', 'primary_key': 'True'})
        },
        'core.language': {
        ...
        'core.linkentry': {
            'Meta': {'ordering': "('container__id', 'seq')", 'object_name': 'LinkEntry', 'db_table': "'zstandard_linkentry'", '_ormbases': ['core.Entry']},
            'entry_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['core.Entry']", 'unique': 'True', 'primary_key': 'True'})
        },
        ...
        'core.pageentry': {
            'Meta': {'ordering': "('container__id', 'seq')", 'object_name': 'PageEntry', 'db_table': "'zstandard_pageentry'", '_ormbases': ['core.Entry']},
            'entry_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['core.Entry']", 'unique': 'True', 'primary_key': 'True'})
        },
        'core.permission': {
        ...
        'core.vfile': {
            'Meta': {'ordering': "('entry', 'version_number')", 'object_name': 'VFile', 'db_table': "'zstandard_vfile'", '_ormbases': ['core.VObject']},
            'content': ('django.db.models.fields.files.FileField', [], {'max_length': '100'}),
            'vobject_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['core.VObject']", 'unique': 'True', 'primary_key': 'True'})
        },
        'core.vimage': {
            'Meta': {'ordering': "('entry', 'version_number')", 'object_name': 'VImage', 'db_table': "'zstandard_vimage'", '_ormbases': ['core.VObject']},
            'content': ('django.db.models.fields.files.ImageField', [], {'max_length': '100'}),
            'vobject_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['core.VObject']", 'unique': 'True', 'primary_key': 'True'})
        },
        'core.vinternalredirection': {
            'Meta': {'ordering': "('entry', 'version_number')", 'object_name': 'VInternalRedirection', 'db_table': "'zstandard_vinternalredirection'", '_ormbases': ['core.VObject']},
            'target': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['core.Entry']"}),
            'vobject_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['core.VObject']", 'unique': 'True', 'primary_key': 'True'})
        },
        'core.vlink': {
            'Meta': {'ordering': "('entry', 'version_number')", 'object_name': 'VLink', 'db_table': "'zstandard_vlink'", '_ormbases': ['core.VObject']},
        ...
        'core.vpage': {
            'Meta': {'ordering': "('entry', 'version_number')", 'object_name': 'VPage', 'db_table': "'zstandard_vpage'", '_ormbases': ['core.VObject']},
