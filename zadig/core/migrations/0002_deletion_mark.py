...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'VObject.deletion_mark'
        db.add_column('zadig_vobject', 'deletion_mark', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'VObject.deletion_mark'
        db.delete_column('zadig_vobject', 'deletion_mark')
