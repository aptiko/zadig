...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'StatePermission', fields ['lentity', 'permission']
        db.delete_unique('zadig_statepermission', ['lentity_id', 'permission_id'])


    def backwards(self, orm):
        
        # Adding unique constraint on 'StatePermission', fields ['lentity', 'permission']
        db.create_unique('zadig_statepermission', ['lentity_id', 'permission_id'])
