...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'VObject.deletion_mark'
    ...
    def backwards(self, orm):
        ...
        # Changing field 'VObject.deletion_mark'
        db.alter_column('zadig_vobject', 'deletion_mark', self.gf('django.db.models.fields.BooleanField')())

        # Deleting field 'StateTransition.lentity'
        db.delete_column('zadig_statetransition', 'lentity_id')

        # Adding unique constraint on 'StateTransition', fields ['target_state', 'source_state']
        db.create_unique('zadig_statetransition', ['target_state_id', 'source_state_id'])
