...
from zadig.core.models import *

class Migration:
    
    def forwards(self, orm):
        
        # Adding field 'Language.descr'
        orm['core.language:descr'].default = 'fixme'
        db.add_column('cms_language', 'descr', orm['core.language:descr'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'Language.descr'
        db.delete_column('cms_language', 'descr')
