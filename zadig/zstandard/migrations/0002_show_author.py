...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'EntryOptions.show_author'
        db.add_column('zstandard_entryoptions', 'show_author', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'EntryOptions.show_author'
        db.delete_column('zstandard_entryoptions', 'show_author')
