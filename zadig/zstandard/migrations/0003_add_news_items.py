...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'NewsItemEntry'
        db.create_table('zstandard_newsitementry', (
        ...
        db.send_create_signal('zstandard', ['NewsItemEntry'])

        # Adding model 'VNewsItem'
        db.create_table('zstandard_vnewsitem', (
            ('vpage_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['zstandard.VPage'], unique=True, primary_key=True)),
            ('news_date', self.gf('django.db.models.fields.DateTimeField')(db_index=True)),
        ))
        db.send_create_signal('zstandard', ['VNewsItem'])

        # Changing field 'EntryOptionSet.no_breadcrumbs'
        db.alter_column('zstandard_entryoptions', 'no_breadcrumbs', self.gf('django.db.models.fields.BooleanField')(blank=True))

        # Changing field 'EntryOptionSet.no_navigation'
        db.alter_column('zstandard_entryoptions', 'no_navigation', self.gf('django.db.models.fields.BooleanField')(blank=True))

        # Changing field 'EntryOptionSet.show_author'
        db.alter_column('zstandard_entryoptions', 'show_author', self.gf('django.db.models.fields.BooleanField')(blank=True))

        # Changing field 'EntryOptionSet.navigation_toplevel'
        db.alter_column('zstandard_entryoptions', 'navigation_toplevel', self.gf('django.db.models.fields.BooleanField')(blank=True))
    
    
    def backwards(self, orm):
        
        # Deleting model 'NewsItemEntry'
        db.delete_table('zstandard_newsitementry')

        # Deleting model 'VNewsItem'
        db.delete_table('zstandard_vnewsitem')

        # Changing field 'EntryOptionSet.no_breadcrumbs'
        db.alter_column('zstandard_entryoptions', 'no_breadcrumbs', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'EntryOptionSet.no_navigation'
        db.alter_column('zstandard_entryoptions', 'no_navigation', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'EntryOptionSet.show_author'
        db.alter_column('zstandard_entryoptions', 'show_author', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'EntryOptionSet.navigation_toplevel'
        db.alter_column('zstandard_entryoptions', 'navigation_toplevel', self.gf('django.db.models.fields.BooleanField')())
