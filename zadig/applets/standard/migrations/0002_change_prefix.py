...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_table('standard_entryoptions', 'zstandard_entryoptions')


    def backwards(self, orm):
        db.rename_table('zstandard_entryoptions', 'standard_entryoptions')
    ...
    models = {
        ...
        'standard.entryoptions': {
            'Meta': {'object_name': 'EntryOptions', 'db_table': "'zstandard_entryoptions'"},
