...
class Migration:
    ...
    def forwards(self, orm):
        ...
        db.create_table('standard_entryoptions', (
            ('entry', orm['standard.EntryOptions:entry']),
            ('no_navigation', orm['standard.EntryOptions:no_navigation']),
        ))
        db.send_create_signal('standard', ['EntryOptions'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('standard_entryoptions')
